    ...
    <>
      ...
      <div className={styles.mobileHeader}>
        ...
        <div className={styles.mobileLogoArea}>
          <Link href="/org" onClick={closeSidebar} className={styles.logoLink} style={{ flexDirection: 'row', alignItems: 'center', gap: '0.5rem' }}>
            <img src="/zeros-logo-white.svg" alt="あわい屋ZEROS" className={styles.mobileLogoImg} />
            <span className={styles.logoBadge}>組織管理者</span>
          </Link>
        </div>
      ...
      <aside className={`${styles.sidebar} ${isOpen ? styles.sidebarOpen : ''}`}>
        <div className={styles.sidebarHeader}>
          <div className={styles.logoArea}>
            <Link href="/org" onClick={closeSidebar} className={styles.logoLink}>
